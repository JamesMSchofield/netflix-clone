...
export const Banner: React.FunctionComponent = ( {netflixOriginals}: Props ) => {
    ...
    return (
    <div className='flex flex-col py-16 lg:min-h-[65vh] lg:justify-center lg:pb-12'>
        <div className="absolute top-0 left-0 -z-10 lg:min-h-[65vh] h-full w-full">
        ...
        <div className='flex space-x-3'>
            ...
            <button className='banner-button bg-[gray]/70'>
                More Info <InformationCircleIcon className='h-4 w-4 md:h-5 md:w-5' />
            </button>
        </div>
    </div>
    )
